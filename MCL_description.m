...
mav_pos_all(1,2,:,:) = [3, 0, 0; 3, 0, 0; 3, 0, 0; 3, 0, 0];
...
mav_orient_all(1,2,:,:) = deg2rad([90; 90; 90; 90]);

mav_pos_all(2,1,:,:) = [-2, 0.5, 0; -2.2, 0.6, 0; -2.1, 0.7, 0; -1.8, 0.4, 0];
mav_pos_all(2,2,:,:) = [3, 0.5, 0; 3, 0.5, 0; 3, 0.5, 0; 3, 0.5, 0];
...
mav_orient_all(2,2,:,:) = deg2rad([82; 82; 82; 82]);

mav_pos_all(3,1,:,:) = [-2, 0.5, 0; -2.2, 0.6, 0; -2.1, 0.7, 0; -1.8, 0.4, 0];
mav_pos_all(3,2,:,:) = [3, 0.5, 0; 3, 0.5, 0; 3, 0.5, 0; 3, 0.5, 0];
...
mav_orient_all(3,2,:,:) = deg2rad([82; 82; 82; 82]);
...
mav_pos_all(4,2,:,:) = [3, 0.5, 0; 3, 0.5, 0; 3, 0.5, 0; 3, 0.5, 0];
...
mav_orient_all(4,2,:,:) = deg2rad([86; 86; 86; 86]);

mav_pos_all(5,1,:,:) = [-2, 0.5, 0; -2.2, 0.6, 0; -2.1, 0.7, 0; -1.8, 0.4, 0];
mav_pos_all(5,2,:,:) = [3, 0.5, 0; 3, 0.5, 0; 3, 0.5, 0; 3, 0.5, 0];
...
mav_orient_all(5,2,:,:) = deg2rad([86; 86; 86; 86]);

mav_pos_all(6,1,:,:) = [-2, 0.5, 0; -2.2, 0.6, 0; -2.1, 0.7, 0; -1.8, 0.4, 0];
mav_pos_all(6,2,:,:) = [3, 0.5, 0; 3, 0.5, 0; 3, 0.5, 0; 3, 0.5, 0];
...
mav_orient_all(6,2,:,:) = deg2rad([86; 86; 86; 86]);
