...
mav_pos_all(2,1,:,:) = [-2, 0, 0; -2.2, 0.1, 0; -2.1, 0.2, 0; -1.8, -0.1, 0];
mav_pos_all(2,2,:,:) = [3, 0, 0; 3.2, 0.2, 0; 3.1, 0.3, 0; 2.8, -0.2, 0];
target_pos_all(2,1,:,:) = [-3.3, 4.5, 0; -2.9, 5.8, 0; -1.3, 6.8, 0; -2.4, 8.5, 0];
...
mav_pos_all(3,1,:,:) = [-2, 0, 0; -2.2, 0.1, 0; -2.1, 0.2, 0; -1.8, -0.1, 0];
mav_pos_all(3,2,:,:) = [3, 0, 0; 3.2, 0.2, 0; 3.1, 0.3, 0; 2.8, -0.2, 0];
target_pos_all(3,1,:,:) = [-3.3, 4.5, 0; -2.9, 5.8, 0; -1.3, 6.8, 0; -1.4, 8.5, 0];
...
mav_pos_all(4,1,:,:) = [-2, 0, 0; -2.2, 0.1, 0; -2.1, 0.2, 0; -1.8, -0.1, 0];
mav_pos_all(4,2,:,:) = [3, 0, 0; 3.2, 0.2, 0; 3.1, 0.3, 0; 2.8, -0.2, 0];
target_pos_all(4,1,:,:) = [-2.0, 6.4, 0; -2.8, 6.6, 0; -2.3, 6.8, 0; -2.1, 9.0, 0];
target_pos_all(4,2,:,:) = [2.0, 6.4, 0; 2.8, 6.6, 0; 2.3, 6.8, 0; 2.1, 9.0, 0];
mav_orient_all(4,1,:,:) = deg2rad([86; 88; 90; 98]);
mav_orient_all(4,2,:,:) = deg2rad([86; 88; 90; 98]);

mav_pos_all(5,1,:,:) = [-2, 0, 0; -2.2, 0.1, 0; -2.1, 0.2, 0; -1.8, -0.1, 0];
mav_pos_all(5,2,:,:) = [3, 0, 0; 3.2, 0.2, 0; 3.1, 0.3, 0; 2.8, -0.2, 0];
target_pos_all(5,1,:,:) = [-2.6, 5.8, 0; -1.6, 6.2, 0; -2.2, 6.4, 0; -2.7, 8.4, 0];
target_pos_all(5,2,:,:) = [2.6, 5.8, 0; 1.6, 6.2, 0; 2.2, 6.4, 0; 2.7, 8.4, 0];
